...
// Work completed by both contributors across the file displayed in brackets
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', (event) => {
    ...
    // Removes the red box if previously entered the incorrect info/lenghth after submitting once correct
